...
const Support = ({ onNavigate, onClose, onOpenSettings }: SupportProps) => {
    ...
    <div className="fixed inset-0 z-[300] flex items-end justify-center">
      ...
      <div className="relative w-full max-w-[393px] bg-[#1E1E1E] rounded-t-3xl overflow-hidden max-h-[85vh] flex flex-col z-[301]">
        ...
        <div className="flex items-center justify-between px-6 pt-6 pb-4 flex-shrink-0">
          <h1 className="text-white text-2xl font-semibold">Поддержка</h1>
          <button 
            onClick={onClose || (() => onNavigate?.('profile'))}
        ...
        <div className="px-6 overflow-y-auto flex-1 min-h-0">
          ...
          <div className="flex flex-col items-center justify-center min-h-[400px] mb-6">
            {/* Icon */}
            <div className="w-20 h-20 rounded-full bg-[#1FD13D]/20 flex items-center justify-center mb-6">
              <img src={supportIcon} alt="Support" width={40} height={40} />
            </div>

            {/* Text */}
            <h2 className="text-white text-xl font-semibold mb-2 text-center">Свяжитесь с нами</h2>
            <p className="text-[#808080] text-sm text-center mb-8">
              Напишите нам в Telegram, и мы обязательно вам поможем
            </p>
            ...
            <a
              ...
              className="w-full max-w-[280px] h-14 rounded-full bg-[#27AE60] flex items-center justify-center gap-3 transition-opacity hover:opacity-90"
            >
              ...
              <span className="text-white text-base font-semibold">Написать в Telegram</span>
            </a>
          </div>
